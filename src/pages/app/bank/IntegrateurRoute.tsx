...
const IntegrateurRoute = () => {

    return(
        <>
            <li className="active">
                <a href="#integrateurRemise" data-toggle="collapse" aria-expanded="false" className="dropdown-toggle"><i className="fa fa-dollar yellow_color"></i> <span>Gestion des remises</span></a>
...
export default IntegrateurRoute;