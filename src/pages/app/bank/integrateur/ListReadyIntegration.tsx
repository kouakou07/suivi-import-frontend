...
const ListReadyIntegration = () => {
    ...
    useEffect(() => {
        httpClient.get(myRoute.listRemiseReadyIntegration.replace("{page}", page))
        .then(res => {
            setIsLoading(false);
            setRemises(res.data);
    ...
    return(
        <Layout title="Les remises a integrer webClearing">
            {isLoading == true && <div className="text-center">
                <BeatLoader />
            </div>}
            {isLoading == false && <div className="row">
                <div className="col-12">
                    <Wrapper title="Les remises validees">
                                        ...
                                        return(
                                            <tr key={remise.id}>
                                                ...
                                                <td className="text-right">
                                                    <Link className="text-success" to={"/banking/integrateur/validation/remise/" + remise.id +"/info"}><i className="fa fa-eye"></i> </Link>
                                                </td>
                                            </tr>
                                        )
                                    })}
...
export default ListReadyIntegration;