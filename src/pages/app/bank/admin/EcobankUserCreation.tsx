...
const EcobankUserCreation = () => {
    ...
    useEffect(() => {
        httpClient.get(myRoute.roleUsersEcobank)
        .then(res => {
            setIsLoading(false);
            setRoles(res.data);
        })
    ...
    const onSubmit = (e: React.FormEvent) =>{
        ...
        httpClient.post(myRoute.createUsersEcobank, encodeData(userData))
        .then(res => {
            setErrors({
                nom: undefined,
                prenom: undefined,
...
export default EcobankUserCreation;